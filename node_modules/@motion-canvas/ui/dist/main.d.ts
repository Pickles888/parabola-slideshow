...
import { CanvasColorSpace } from '@motion-canvas/core';
import { Color } from '@motion-canvas/core';
import { ColorMetaField } from '@motion-canvas/core';
import { ComponentChild } from 'preact';
import { ComponentChildren } from 'preact';
import { EnumMetaField } from '@motion-canvas/core';
import { EventHandler } from '@motion-canvas/core';
import { ExporterMetaField } from '@motion-canvas/core';
...
import { LogPayload } from '@motion-canvas/core';
import { MetaField } from '@motion-canvas/core';
import { MutableRef } from 'preact/hooks';
import { NumberMetaField } from '@motion-canvas/core';
import type { ObjectMetaField } from '@motion-canvas/core';
import type { Player } from '@motion-canvas/core';
import { PlayerState } from '@motion-canvas/core';
import { Plugin as Plugin_2 } from '@motion-canvas/core';
import type { Presenter } from '@motion-canvas/core';
import { PresenterState } from '@motion-canvas/core';
import { Project } from '@motion-canvas/core';
import type { ProjectMetadata } from '@motion-canvas/core';
import { Provider } from 'preact';
import { RangeMetaField } from '@motion-canvas/core';
import { ReadonlySignal } from '@preact/signals';
import { Ref } from 'preact';
import type { Renderer } from '@motion-canvas/core';
import { RendererState } from '@motion-canvas/core';
import { Scene } from '@motion-canvas/core';
import type { SettingsMetadata } from '@motion-canvas/core';
...
import { Subscribable } from '@motion-canvas/core';
import { SubscribableValueEvent } from '@motion-canvas/core';
import { ValueOf } from '@motion-canvas/core';
...
export declare function NumberInput({ value, onChange, min, max, step, decimalPlaces, label, ...props }: NumberInputProps): JSX_2.Element;

declare type NumberInputProps = Omit<JSX_2.HTMLAttributes<HTMLInputElement>, 'value' | 'onChange' | 'min' | 'max' | 'step' | 'label'> & {
    value: number;
...
export declare type NumberInputSelectProps = Omit<JSX_2.HTMLAttributes<HTMLInputElement>, 'value' | 'onChange' | 'min' | 'max' | 'step' | 'label'> & SelectProps<number> & {
    value: number;
    min?: number;
    max?: number;
    step?: number;
